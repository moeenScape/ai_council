        ...
        >
          <div className="glass-panel p-8 rounded-2xl max-w-md mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Get the best answers by comparing GPT, Claude, and Grok side by side.
            </p>
            <div className="flex justify-center gap-4">
              <div className="px-4 py-2 rounded-lg bg-gpt/20 text-gpt text-sm font-medium">GPT</div>
              <div className="px-4 py-2 rounded-lg bg-claude/20 text-claude text-sm font-medium">Claude</div>
              <div className="px-4 py-2 rounded-lg bg-grok/20 text-grok text-sm font-medium">Grok</div>
            </div>
          </div>
        </motion.div>
      </div>

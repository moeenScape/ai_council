        ...
        >
          <div className="glass-panel p-8 rounded-2xl max-w-md mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              No credit card required. Get 10 free comparisons per day.
            </p>
            <ul className="text-left space-y-3">
              {["Compare up to 3 AI models", "Support for code, text, and more", "Export your best results"].map((item) => (
              ...
              {password && (
                <ul className="mt-2 space-y-1">
                  {passwordRequirements.map((req) => (
                    <li key={req.text} className={`text-xs flex items-center gap-2 ${req.met ? 'text-gpt' : 'text-muted-foreground'}`}>
